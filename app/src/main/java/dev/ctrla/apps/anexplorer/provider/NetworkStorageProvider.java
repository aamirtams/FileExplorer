...
import dev.ctrla.apps.anexplorer.network.NetworkFile;

import static dev.ctrla.apps.anexplorer.misc.MimeTypes.BASIC_MIME_TYPE;
import static dev.ctrla.apps.anexplorer.model.DocumentInfo.getCursorInt;
import static dev.ctrla.apps.anexplorer.network.NetworkConnection.SERVER;
import static dev.ctrla.apps.anexplorer.provider.ExplorerProvider.ConnectionColumns;
