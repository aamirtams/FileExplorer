...
import static dev.ctrla.apps.anexplorer.R.id.action_close;
import static dev.ctrla.apps.anexplorer.R.id.action_feedback;
import static dev.ctrla.apps.anexplorer.R.id.action_rate;
