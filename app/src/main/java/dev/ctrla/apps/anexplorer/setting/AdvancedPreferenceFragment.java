...
import static dev.ctrla.apps.anexplorer.setting.SettingsActivity.KEY_ADVANCED_DEVICES;
import static dev.ctrla.apps.anexplorer.setting.SettingsActivity.KEY_FOLDER_ANIMATIONS;
import static dev.ctrla.apps.anexplorer.setting.SettingsActivity.KEY_ROOT_MODE;
