...
package dev.ctrla.apps.anexplorer.provider;
...
import dev.ctrla.apps.anexplorer.libcore.util.Objects;
...
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.METHOD_COMPRESS_DOCUMENT;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.METHOD_COPY_DOCUMENT;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.METHOD_CREATE_DOCUMENT;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.METHOD_DELETE_DOCUMENT;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.METHOD_IS_CHILD_DOCUMENT;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.METHOD_MOVE_DOCUMENT;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.METHOD_REMOVE_DOCUMENT;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.METHOD_RENAME_DOCUMENT;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.METHOD_UNCOMPRESS_DOCUMENT;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.buildDocumentUri;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.buildDocumentUriMaybeUsingTree;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.buildTreeDocumentUri;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.getDocumentId;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.getRootId;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.getSearchDocumentsQuery;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.getTreeDocumentId;
import static dev.ctrla.apps.anexplorer.model.DocumentsContract.isTreeUri;
