...
package dev.ctrla.apps.anexplorer;
...
import dev.ctrla.apps.anexplorer.archive.DocumentArchiveHelper;
import dev.ctrla.apps.anexplorer.fragment.ConnectionsFragment;
import dev.ctrla.apps.anexplorer.fragment.CreateDirectoryFragment;
import dev.ctrla.apps.anexplorer.fragment.CreateFileFragment;
import dev.ctrla.apps.anexplorer.fragment.DirectoryFragment;
import dev.ctrla.apps.anexplorer.fragment.HomeFragment;
import dev.ctrla.apps.anexplorer.fragment.MoveFragment;
import dev.ctrla.apps.anexplorer.fragment.PickFragment;
import dev.ctrla.apps.anexplorer.fragment.RecentsCreateFragment;
import dev.ctrla.apps.anexplorer.fragment.RootsFragment;
import dev.ctrla.apps.anexplorer.fragment.SaveFragment;
import dev.ctrla.apps.anexplorer.fragment.ServerFragment;
import dev.ctrla.apps.anexplorer.libcore.io.IoUtils;
import dev.ctrla.apps.anexplorer.misc.AnalyticsManager;
import dev.ctrla.apps.anexplorer.misc.AppRate;
import dev.ctrla.apps.anexplorer.misc.AsyncTask;
import dev.ctrla.apps.anexplorer.misc.ConnectionUtils;
...
import dev.ctrla.apps.anexplorer.misc.IntentUtils;
import dev.ctrla.apps.anexplorer.misc.MimePredicate;
import dev.ctrla.apps.anexplorer.misc.PermissionUtil;
import dev.ctrla.apps.anexplorer.misc.PinViewHelper;
import dev.ctrla.apps.anexplorer.misc.PinViewHelper.PINDialogFragment;
import dev.ctrla.apps.anexplorer.misc.ProviderExecutor;
import dev.ctrla.apps.anexplorer.misc.RootsCache;
import dev.ctrla.apps.anexplorer.misc.SAFManager;
import dev.ctrla.apps.anexplorer.misc.SystemBarTintManager;
import dev.ctrla.apps.anexplorer.misc.Utils;
import dev.ctrla.apps.anexplorer.model.DocumentInfo;
import dev.ctrla.apps.anexplorer.model.DocumentStack;
import dev.ctrla.apps.anexplorer.model.DocumentsContract;
import dev.ctrla.apps.anexplorer.model.DocumentsContract.Root;
import dev.ctrla.apps.anexplorer.model.DurableUtils;
import dev.ctrla.apps.anexplorer.model.RootInfo;
import dev.ctrla.apps.anexplorer.network.NetworkConnection;
import dev.ctrla.apps.anexplorer.provider.ExternalStorageProvider;
import dev.ctrla.apps.anexplorer.provider.RecentsProvider;
import dev.ctrla.apps.anexplorer.provider.RecentsProvider.RecentColumns;
import dev.ctrla.apps.anexplorer.provider.RecentsProvider.ResumeColumns;
import dev.ctrla.apps.anexplorer.setting.SettingsActivity;
import dev.ctrla.apps.anexplorer.ui.AdWrapper;
import dev.ctrla.apps.anexplorer.ui.DirectoryContainerView;
import dev.ctrla.apps.anexplorer.ui.FloatingActionsMenu;
import dev.ctrla.apps.anexplorer.ui.fabs.SimpleMenuListenerAdapter;

import static dev.ctrla.apps.anexplorer.BaseActivity.State.ACTION_BROWSE;
import static dev.ctrla.apps.anexplorer.BaseActivity.State.ACTION_CREATE;
import static dev.ctrla.apps.anexplorer.BaseActivity.State.ACTION_GET_CONTENT;
import static dev.ctrla.apps.anexplorer.BaseActivity.State.ACTION_MANAGE;
import static dev.ctrla.apps.anexplorer.BaseActivity.State.ACTION_OPEN;
import static dev.ctrla.apps.anexplorer.BaseActivity.State.ACTION_OPEN_TREE;
import static dev.ctrla.apps.anexplorer.BaseActivity.State.MODE_GRID;
import static dev.ctrla.apps.anexplorer.BaseActivity.State.MODE_LIST;
import static dev.ctrla.apps.anexplorer.DocumentsApplication.isTelevision;
import static dev.ctrla.apps.anexplorer.fragment.DirectoryFragment.ANIM_DOWN;
import static dev.ctrla.apps.anexplorer.fragment.DirectoryFragment.ANIM_NONE;
import static dev.ctrla.apps.anexplorer.fragment.DirectoryFragment.ANIM_SIDE;
import static dev.ctrla.apps.anexplorer.fragment.DirectoryFragment.ANIM_UP;
import static dev.ctrla.apps.anexplorer.misc.AnalyticsManager.FILE_COUNT;
import static dev.ctrla.apps.anexplorer.misc.AnalyticsManager.FILE_MOVE;
import static dev.ctrla.apps.anexplorer.misc.AnalyticsManager.FILE_TYPE;
import static dev.ctrla.apps.anexplorer.misc.SAFManager.ADD_STORAGE_REQUEST_CODE;
import static dev.ctrla.apps.anexplorer.misc.Utils.EXTRA_ROOT;
import static dev.ctrla.apps.anexplorer.provider.ExternalStorageProvider.isDownloadAuthority;
...
*/
      ...
      //  adWrapper = (AdWrapper)findViewById(R.id.adWrapper);
      //  adWrapper.initInterstitialAd();
    }
    ...
    private void initProtection() {
        ...
        }.getView(), new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
    ...
    private void onFinished(Uri... uris) {
        ...
        if (mState.action == State.ACTION_GET_CONTENT) {
