package dev.ctrla.apps.anexplorer.setting;
...
import static dev.ctrla.apps.anexplorer.setting.SettingsActivity.KEY_FILE_HIDDEN;
import static dev.ctrla.apps.anexplorer.setting.SettingsActivity.KEY_FILE_SIZE;
import static dev.ctrla.apps.anexplorer.setting.SettingsActivity.KEY_FILE_THUMBNAIL;
import static dev.ctrla.apps.anexplorer.setting.SettingsActivity.KEY_FOLDER_SIZE;
import static dev.ctrla.apps.anexplorer.setting.SettingsActivity.KEY_RECENT_MEDIA;
