package dev.ctrla.apps.anexplorer.network;
...
import dev.ctrla.apps.anexplorer.misc.LogUtils;
import dev.ctrla.apps.anexplorer.model.Durable;
...
import dev.ctrla.apps.anexplorer.provider.ExplorerProvider.ConnectionColumns;
import dev.ctrla.apps.anexplorer.provider.NetworkStorageProvider;

import static dev.ctrla.apps.anexplorer.model.DocumentInfo.getCursorBolean;
